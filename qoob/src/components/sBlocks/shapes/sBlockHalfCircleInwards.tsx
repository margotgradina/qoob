...
const SBlockHalfCircleInwards = (props: sBlockHalfCircleProps) => {
  return (
    <>
      <div
        className={css`
      ...
      >
        ...
        >
          <SBlockUnit
            ...
            borderRadius={`${props.bR} 0px 0px 0px`}
          />
          <SBlockUnit
            colour={props.colour}
            rotate={"0deg"}
            size={props.size * 0.5}
            sizeUnit={props.sizeUnit}
            borderRadius={`0px 0px 0px ${props.bR}`}
          />
        </div>
        {/* SECOND ROW */}
        <div
...
export default SBlockHalfCircleInwards;
